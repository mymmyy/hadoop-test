package com.mym.mr.flowcountsort;
...
public class FlowCountSort {
    ...
    private static Comparator<FlowBean> comparator = new Comparator<FlowBean>() {
        @Override
    ...
    private static TreeMap<FlowBean, Text> resultMap = new TreeMap<FlowBean, Text>(comparator);
    ...
    static class FlowCountReducer extends Reducer<Text, FlowBean,Text, FlowBean>{
        ...
        protected void reduce(Text key, Iterable<FlowBean> values, Context context) throws IOException, InterruptedException {
            ...
            resultMap.put(new FlowBean(sum_upFlow, sum_dFlow),key);
        }
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            ...
            while (iterator.hasNext()){
                ...
                context.write(resultMap.get(next), next);
            }
        }
